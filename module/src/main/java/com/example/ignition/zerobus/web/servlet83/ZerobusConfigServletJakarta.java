package com.example.ignition.zerobus.web.servlet83;
...
/**
 * Ignition 8.3+ servlet implementation (jakarta.servlet.*).
 * Mounted at /system/zerobus via WebResourceManager.
 */
public class ZerobusConfigServletJakarta extends HttpServlet {
    private static final Logger logger = LoggerFactory.getLogger(ZerobusConfigServletJakarta.class);
